        ...
        <div class="mx-4 sm:p-8">
            <form method="POST" action="{{route('book.store')}}" enctype="multipart/form-data">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <textarea name="description" class="w-auto py-2 border border-gray-300 rounded-md" id="body" cols="30" rows="10"></textarea>
                </div>
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="url" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="url" placeholder="Enter URL">
                </div>
